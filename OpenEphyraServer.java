...
import info.ephyra.search.searchers.SparqlKM;
...
public class OpenEphyraServer extends AbstractHandler {
	...
	public OpenEphyraServer(String dir) {
		...
		MsgPrinter.printStatusMsg("Loading SPARQL templates...");
		if (!SparqlKM.loadPatterns(dir +
				"res/SPARQLTemplates"))
		MsgPrinter.printErrorMsg("Could not load SPARQL query templates.");
	}
	...
	protected void initFactoid() {
        ...
        Search.addKnowledgeMiner(new SparqlKM());
